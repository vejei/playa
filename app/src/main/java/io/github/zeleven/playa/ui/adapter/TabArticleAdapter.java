...
public class TabArticleAdapter extends BaseRecyclerViewAdapter<Article, RecyclerView.ViewHolder> {
        ...
        switch (viewType) {
            case VIEW_TYPE_ITEM:
                viewHolder = new ItemViewHolder(LayoutInflater.from(
                        parent.getContext()).inflate(R.layout.tab_article_list_item, parent, false));
                break;
